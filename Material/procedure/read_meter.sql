...
BEGIN
    ...
    VALUES (d_id, r_date, begin_num, r_number, b_fee, b_fee*0.08, b_fee*add_price, b_fee + b_fee*0.08 + b_fee*add_price, null, null, LAST_DAY(r_date), null, 0, '0');
